                ...
                <div className="main-slider-one__content">
                  ...
                  <h2 className="main-slider-one__title">
                    <span className="main-slider-one__title__inner">
                      <span className="main-slider-one__title__text main-slider-one__title__text--1">
                        Smart finance
                      </span>
                    </span>
                    <span className="main-slider-one__title__inner">
                      <span className="main-slider-one__title__text main-slider-one__title__text--2">
                        solutions for your
                      </span>
                    </span>
                    <span className="main-slider-one__title__inner">
                      <span className="main-slider-one__title__text main-slider-one__title__text--3">
                        business
                      </span>
                    </span>
                  </h2>
                  ...
                  <div className="main-slider-one__button-group">
                    <div className="main-slider-one__button-group__inner">
                      <div className="main-slider-one__button main-slider-one__button--1">
                        <a
                          href="services.html"
                          className="main-slider-one__btn-1 easilon-btn"
                        >
      ...
      <div className="item">
        <div className="main-slider-one__item">
          <div
            ...
            style={{
              backgroundImage:
                "url(assets/images/backgrounds/main-slider-bg-1-2.jpg)"
            }}
          ></div>
          {/* /.main-slider-one__bg */}
          <div className="main-slider-one__container container">
      ...
      <div className="item">
        <div className="main-slider-one__item">
          <div
            ...
            style={{
              backgroundImage:
                "url(assets/images/backgrounds/main-slider-bg-1-3.jpg)"
            }}
          ></div>
          {/* /.main-slider-one__bg */}
          <div className="main-slider-one__container container">
        ...
        <div className="container">
          <div className="main-slider-one__form">
            <form
              ...
              className="loan-calculator-form wow fadeInUp"
              data-wow-duration="1500ms"
            >
              <h3 className="loan-calculator-form__title">
              ...
              <div className="loan-calculator-form__content">
                ...
                <p>
                  ...
                  <b>
                    $<i className="loan-monthly-pay" />
                  </b>
                </p>
                <p>
                  <span>Term of Use</span>
                  <b>
                    <i className="loan-month" /> Months
                  </b>
                </p>
                <p>
                  <span>Total Pay Back amount</span>
                  <b>
                    $<i className="loan-total" />
                  </b>
                </p>
                <button
                  type="submit"
                  className="easilon-btn loan-calculator-form__btn"
                >
