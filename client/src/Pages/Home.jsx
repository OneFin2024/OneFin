  ...
  >
        <div className="item">
          <div className="main-slider-one__item">
            <div className="main-slider-one__bg" style={{}}>
        ...
        <div className="item">
          <div className="main-slider-one__item">
            <div className="main-slider-one__bg" style={{backgroundImage: 'url(assets/images/backgrounds/main-slider-bg-1-2.jpg)'}}>
            </div>{/* /.main-slider-one__bg */}
            <div className="main-slider-one__container container">
              <div className="row gutter-y-60 align-items-center">
                <div className="col-lg-7">
                  <div className="main-slider-one__content">
                    ...
                    <h2 className="main-slider-one__title">
                      <span className="main-slider-one__title__inner">
                        <span className="main-slider-one__title__text main-slider-one__title__text--1">Our
                          Loans will</span>
                      </span>
                      <span className="main-slider-one__title__inner">
                        <span className="main-slider-one__title__text main-slider-one__title__text--2">Make
                          Your Dreams</span>
                      </span>
                      <span className="main-slider-one__title__inner">
                        <span className="main-slider-one__title__text main-slider-one__title__text--3">Come
                          True</span>
                      </span>
                    </h2>{/* /.slider-title */}
                    <div className="main-slider-one__button-group">
        ...
        <div className="item">
          <div className="main-slider-one__item">
            <div className="main-slider-one__bg" style={{backgroundImage: 'url(assets/images/backgrounds/main-slider-bg-1-3.jpg)'}}>
            </div>{/* /.main-slider-one__bg */}
            <div className="main-slider-one__container container">
              <div className="row gutter-y-60 align-items-center">
                <div className="col-lg-7">
                  <div className="main-slider-one__content">
                    ...
                    <h2 className="main-slider-one__title">
                      <span className="main-slider-one__title__inner">
                        <span className="main-slider-one__title__text main-slider-one__title__text--1">Personal
                          loans</span>
                      </span>
                      <span className="main-slider-one__title__inner">
                        <span className="main-slider-one__title__text main-slider-one__title__text--2">to
                          fulfill your</span>
                      </span>
                      <span className="main-slider-one__title__inner">
                        <span className="main-slider-one__title__text main-slider-one__title__text--3">dreams</span>
                      </span>
                    </h2>{/* /.slider-title */}
                    <div className="main-slider-one__button-group">
                      <div className="main-slider-one__button-group__inner">
